...
const About = () => {
  return (
    <>
      ...
      >
        I'm a skilled software developer with experience  in frontend, backend,
        databases, and API integration. I'm a quick learner and loves teamwork, 
        learning new technologies,and applying my knowledge to real-world projects 
